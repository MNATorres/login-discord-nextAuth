          ...
          <Flex alignItems={"center"}>
            <Stack direction={"row"} spacing={7}>
              ...
              <Button
                ...
                bg={"blue.400"}
                href={
                  "https://discord.com/api/oauth2/authorize?client_id=1161097485230542900&redirect_uri=http%3A%2F%2Flocalhost%3A3000&response_type=code&scope=identify%20email"
                }
                _hover={{
                  bg: "blue.300",
                }}
